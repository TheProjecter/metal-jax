		...
		var $source = {
			...
			setting: {
				...
				stereotype: [
					...
					{ type:"context", base:"metal.jax.core.Context" },
					{ type:"resource", base:"metal.jax.Resource" },
					{ type:"model", base:"metal.jax.Model" },
					{ type:"service", base:"metal.jax.Service" },
					{ type:"view", base:"metal.jax.face.View" },
					{ type:"controller", base:"metal.jax.face.Controller" },
					{ type:"script", base:"metal.jax.resource.Script" },
					{ type:"stylesheet", base:"metal.jax.resource.StyleSheet" }
				]
			}
		};
		var _URL_ = /(?:([^\/:]+:\/\/[^\/]*)?([^?&#]+)?)(?:\?([^&#]+)?(?:&([^#]+))?)?(?:#(.+))?/;
