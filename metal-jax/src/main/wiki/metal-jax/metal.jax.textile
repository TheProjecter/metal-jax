...
See also: "@metal.jax.core.Context@":metal.jax.core.Context.html
...
| bootContext | @boot@ | The initial metal-jax context. |
...
| name | @metal.jax.core.Context@ | Identifies source as well as class/context. |
...
table(grid).
|_.Name |_.Value |_.Comments |
| class | @metal.jax.BaseObject@ | Class source. |
| context | @metal.jax.core.Context@ | Context source. |
| face | @metal.jax.resource.Face@ | Face source. |
| html | @metal.jax.resource.Face@ | HTML source. |
